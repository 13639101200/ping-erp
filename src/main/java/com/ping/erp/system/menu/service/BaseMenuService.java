package com.ping.erp.system.menu.service;
...
public interface BaseMenuService {
	...
	Set<BaseMenu> findTreeByUserAndPidAndTypeId(BaseUser user, String pid, String typeId);

	Set<BaseMenu> findTreeByPidRelCompany(String pid, BaseCompany company);

	Set<BaseMenu> findTreeByCompanyAndPidRelRole(String pid, BaseRole role);
